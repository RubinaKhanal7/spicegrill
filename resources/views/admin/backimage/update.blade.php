...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form id="quickForm" method="POST" action="{{ route('Backimage.update') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{ $backimage->id }}">
                ...
                <div class="form-group">
                    ...
                    <input style="width:auto;" type="text" name="title" class="form-control" id="title"
                        placeholder="Title" value="{{ $backimage->title }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <img id="preview1" src="{{ url('uploads/backimage/' . $backimage->image) }}"
