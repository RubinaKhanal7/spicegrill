  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="https://aashatech.com">Aasha Tech Pvt. Ltd.</a>.</strong>
    All rights reserved.
...
<!-- AdminLTE App -->
<script src="{{ asset('ad/js/adminlte.js') }}"></script>
<!-- AdminLTE for demo purposes -->

{{-- <script src="{{ asset('ad/js/demo.js') }}"></script> --}}

<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('ad/js/pages/dashboard.js') }}"></script>
