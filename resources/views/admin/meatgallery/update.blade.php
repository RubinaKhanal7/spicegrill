...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form id="quickForm" method="POST" action="{{ route('Meatgallery.update') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{ $meatgallerys->id }}">
                ...
                <div class="form-group">
                    ...
                    <input style="width:auto;" type="text" name="title" class="form-control" id="title"
                        placeholder="Title" value="{{ $meatgallerys->title }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <img id="preview1" src="{{ url('uploads/meatgallery/' . $meatgallerys->image) }}"
