...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form id="quickForm" method="POST" action="{{ route('Photogallery.update') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input style="width:auto;" type="text" name="title" class="form-control" id="title"
                        placeholder="Title" value="{{ $photogallery->title }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <img id="preview1" src="{{ url('uploads/photogallery/' . $photogallery->image) }}"
