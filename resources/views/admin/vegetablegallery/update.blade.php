...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form id="quickForm" method="POST" action="{{ route('Vegetablegallery.update') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{ $vegetablegallerys->id }}">
                ...
                <div class="form-group">
                    ...
                    <input style="width:auto;" type="text" name="title" class="form-control" id="title"
                        placeholder="Title" value="{{ $vegetablegallerys->title }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <img id="preview1" src="{{ url('uploads/vegetablegallery/' . $vegetablegallerys->image) }}"
