...
@section('content')
    ...
    <form id="quickForm" novalidate="novalidate" method="POST" action="{{ route('Viewmenu.store') }}"
        ...
        <div class="form-group">
            ...
            <input style="width:auto;" type="text" name="price" class="form-control" id="title"
