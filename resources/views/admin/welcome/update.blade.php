...
<form id="quickForm" method="POST" action="{{ route('Welcome.update') }}"
...
<div class="card-body">
    <div class="form-group">
        ...
        <input type="text" name="title" value="{{ $welcome->title ?? '' }}" class="form-control" placeholder="Title">
    </div>
    <div class="form-group">
        <label for="exampleInputEmail1">Subtitle</label>
        <input type="text" name="subtitle" value="{{ $welcome->subtitle ?? '' }}" class="form-control" placeholder="Subtitle">
    </div>
    ...
    <img id="preview" src="{{ url('uploads/welcome/'.$welcome->image) }}" style="max-width: 500px; max-height:500px" />
